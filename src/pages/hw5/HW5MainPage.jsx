...
import Alert from "../../components/hw5/Alert";
import ExpenseForm from "../../components/hw5/ExpenseForm";
import ExpenseList from "../../components/hw5/ExpenseList";
import "./style.css";

export default function HW5MainPage() {
  ...
  return (
    <div className=" bg-amber-400 h-screen">
      <main className="main-container pt-10">
        ...
        <h1 className=" text-3xl font-bold pb-3">예산 계산기</h1>
